...
1. **Loading and Processing Data**:
   - You must read the `./artifacts/bg_info.txt` file generated by the researcher agent to review the analysis results
   - You must read the `./artifacts/all_results.txt` file generated by the coder agent to review the analysis results
   - This files contains accumulated information from all research and analysis stages and results
